  ...
  return (
    <div className="question-container">
      ...
      <ul className="option-list">
        <li>
          <button onClick={() => navigate("/sad1c4a1")}>
            a) Not much, I can still enjoy some things
          </button>
        </li>
        <li>
          <button onClick={() => navigate("/sad1c4a1")}>
            b) Quite a bit, most things don't feel good
          </button>
        </li>
        <li>
          <button onClick={() => navigate("/sad1c4a1")}>
            c) Completely, nothing brings me joy anymore
          </button>
        </li>
      </ul>
