  ...
  return (
    <div className="question-container">
      ...
      <ul className="option-list">
        <li>
          <button onClick={() => navigate("/angry2a")}>
            a) It happens pretty often, little things get under my skin
          </button>
        </li>
        <li>
          <button onClick={() => navigate("/angry2b")}>
            b) No, usually I'm quite calm. This is unusual
          </button>
        </li>
      </ul>
