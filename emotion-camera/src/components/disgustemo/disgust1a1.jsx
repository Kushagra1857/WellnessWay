  ...
  return (
    <div className="question-container">
      ...
      <ul className="option-list">
        <li>
          <button onClick={() => navigate("/disgust1a1a")}>
            a) If Intensity is 1-5 (Mild to Moderate Disgust)
          </button>
        </li>
        <li>
          <button onClick={() => navigate("/disgust1a1b")}>
            b) If Intensity is 6-10 (Strong to Extreme Disgust).
          </button>
        </li>
      </ul>
